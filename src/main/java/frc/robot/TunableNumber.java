package frc.robot;
/*This is the Tunable Numbers File!
This file needs to be imported to use this form of tunable numbers.
It creates a class that allows us to utilize tunable numbers.
A tunable number is a variable that you're able to change, then use without redeploying the code.
We use tunable numbers in order to save time on processes that need to have variables changed a lot.
These processes are things like configuring motor speeds and tuning PID values.
The tunable numbers themselves are changed in the dashboard Elastic
*/
